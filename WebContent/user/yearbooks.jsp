...
<div class="container">
    ...
    <div style="height: 1000px;color: black;">
    	...
    	<div style="background-color: ;float: left; width: 85%;height: 100%;text-align: center;" >
    		<br>
    		<b style="font-family: '楷体';font-size: 40px;color: black">年鉴</b>
    		<hr>
			<div style="float: left; width: 100%;height: 300px;text-align: left;">
    			<div style="text-align: right; float: left; width: 20%;height: 100%;">
    				<img src="${pageContext.request.contextPath }/img/ZQNJ2017.jpg" width="200px" height="288px"/>
    			</div>
    			<div style="float: left; width: 80%;height: 100%;">
    				<p style="text-indent: 2em; font-size: 22px;line-height: 22px;"><b>肇庆年鉴2017</b></p>
    				<br>
    				<p style="text-indent: 2.5em; font-size: 18px;line-height: 22px;">主编：肇庆年鉴编纂委员会</p>
    				<br>
    		...
    		<div style="float: left; width: 100%;height: 300px;text-align: left;">
    			<div style="text-align: right; float: left; width: 20%;height: 100%;">
    				<img src="${pageContext.request.contextPath }/img/ZQNJ2016.jpg" width="200px" height="288px"/>
    			</div>
    			<div style="float: left; width: 80%;height: 100%;">
    				<p style="text-indent: 2em; font-size: 22px;line-height: 22px;"><b>肇庆年鉴2016</b></p>
    				<br>
    				<p style="text-indent: 2.5em; font-size: 18px;line-height: 22px;">主编：肇庆年鉴编纂委员会</p>
    				<br>
    				<p style="text-indent: 2.5em; font-size: 18px;line-height: 22px;">出版社：中华书局</p>
    		...
    		<div style="float: left; width: 100%;height: 300px;text-align: left;">
    			<div style="text-align: right; float: left; width: 20%;height: 100%;">
    				<img src="${pageContext.request.contextPath }/img/ZQNJ2015.jpg" width="200px" height="288px"/>
    			</div>
    			<div style="float: left; width: 80%;height: 100%;">
    				<p style="text-indent: 2em; font-size: 22px;line-height: 22px;"><b>肇庆年鉴2015</b></p>
    				<br>
    				<p style="text-indent: 2.5em; font-size: 18px;line-height: 22px;">主编：肇庆年鉴编纂委员会</p>
    				<br>
    				<p style="text-indent: 2.5em; font-size: 18px;line-height: 22px;">出版社：中华书局</p>
