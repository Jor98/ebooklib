...
<div class="container">
    ...
    <div style="height: 250px;color: black;">
    	...
    	<div style="background-color: ;float: left; width: 85%;height: 100%;text-align: center;" >
    		<br>
    		<b style="font-family: '楷体';font-size: 40px;color: black">数字资源</b>
    		<hr>
			<p style="text-indent: 2em; text-align: left;font-size: 18px;line-height: 22px;">成都数字图书馆由成都图书馆独立建设，主要资源有：超星电子书（学术视频、百联搜索）、龙源期刊、Apabi电子书、CNKI期刊数据库、 万方数据库、KUKE库克音乐图书馆、新东方、围棋自学平台、点点漫画、全国电子报纸、蔚秀学术视频、维普考试资源、职业全能培训库。 2015年7月13日起面向“成都市公共图书馆联盟”（成都图书馆+20家县级公共图书馆）的身份证注册读者免费使用，如何使用：</p>
			<p style="text-indent: 2em;text-align: left;font-size: 18px;line-height: 22px;">通过SSO（Single Sign On）使用：凡成都市任意公共图书馆用身份证注册的读者，可凭身份证号和注册时设置的密码登录成都市 公共图书馆数字资源共享平台“SSO”（独立访问域名sso.cdclib.org）使用以上资源，本站可直接在首页登录后进入资源列表。</p>
