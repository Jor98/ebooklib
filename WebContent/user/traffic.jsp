    ...
    <div style="height: 500px;color: black;">
    	...
    	<div style="background-color: ;float: left; width: 85%;height: 100%;text-align: center;" >
    		...
    		<div style="width: 50%;height:100%;float: left;">
    			<br>
    			<br>
    			<img src="${pageContext.request.contextPath }/img/map.png" height="80%" width="80%"/>
    		</div>
    		<div style="width: 50%;height:100%;float: left;text-align: left;">
    			<br>
    			<h1><b style="font-family: '楷体';">肇庆学院·真香图书馆</b></h1>
    			<br>
    			<p style="font-size: 15px;">本馆地址：肇庆学院真香图书馆</p>
    			<br>
    			<p style="font-size: 15px;">本馆网址：www.zqu.ZHlibrary.cong</p>
    			<br>
    			<p style="font-size: 15px;">附件公交站：肇庆学院站：10路、30路</p>
    			<br>
    			<p style="font-size: 15px;">附件地铁站：端州轻轨站</p>
    		</div>
