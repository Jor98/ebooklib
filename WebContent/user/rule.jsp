...
<div class="container">
    ...
    <div style="height: 400px;color: black;">
    	...
    	<div style="width: 15%;height: 100%;float: left;" >
    		<div style=" width: 100%;height: 80px;background:#6986eb;text-align: center;line-height: 80px;font-size: 30px;font-family: '楷体';"><b style="color: black;">读者服务</b></div>
    		<div class="div11"><b style="color: black;"><a style="color: black;" href="${pageContext.request.contextPath }/user/rule.jsp">借还规则</a></b></div>	
    	</div>
    	
    	<div style="background-color: ;float: left; width: 85%;height: 100%;text-align: center;" >
    		<br>
    		<b style="font-family: '楷体';font-size: 40px;color: black">借还规则</b>
    		<hr>
			<p style="text-indent: 2em; text-align: left;font-size: 18px;line-height: 22px;">读者凭注册身份证可借阅图书8本、期刊4本、音像光盘1碟（种）；外借借期为30天（可电话或网上续借1次/30天），期满后读者需及时归，续借</p>
			<p style="text-align: left;font-size: 18px;line-height: 22px;">仅一次，超期将按0.1元/本·天，收取滞纳金。出现丢失、毁坏等情况按规定赔偿。</p>
			<p style="text-indent: 2em;text-align: left;font-size: 18px;line-height: 22px;">读者凭读者证可借阅中文图书8本、期刊4本；外借借期为30天（可电话或网上续借1次/30天），期满后读者需及时归，续借仅一次，超期将按0.1</p>
			<p style="text-align: left;font-size: 18px;line-height: 22px;">元/本·天，收取滞纳金。出现丢失、毁坏等情况按规定赔偿。</p>
			<br>
			<p style="text-align: left;font-size: 18px;line-height: 22px;">积分规则： 1、初始积分  新注册读者可获得初始积分300分，已注册的读者在积分系统上线时自动获得初始积分300分。</p>
			<p style="text-indent: 5.3em;text-align: left;font-size: 18px;line-height: 22px;"> 2、加分  每借1册图书或期刊可加2分，每天借书积分最多增加24分，每月借书积分最多增加500分。办理借书手续后系统自动加分。</p>
			<p style="text-indent: 5.3em;text-align: left;font-size: 18px;line-height: 22px;">3、扣分  逾期归还图书或期刊每册每天扣减1分，损坏文献每册扣减25分；遗失文献按每册扣减50分。办理以上手续后系统自动扣分。</p>
			<p style="text-indent: 5.3em;text-align: left;font-size: 18px;line-height: 22px;">4、积分抵扣滞纳金  积分可抵扣逾期滞纳金，1分可抵扣0.01元，只能全额抵扣。积分抵扣滞纳金是还书时在人工服务窗口进行办理。</p>
