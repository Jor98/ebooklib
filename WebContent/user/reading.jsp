...
<div class="container">
    ...
    <div style="height: 500px;color: black;">
    	...
    	<div style="width: 15%;height: 100%;float: left;" >
    		<div style=" width: 100%;height: 80px;background:#6986eb;text-align: center;line-height: 80px;font-size: 30px;font-family: '楷体';"><b style="color: black;">数字阅读</b></div>
    		<div class="div11"><b style="color: black;"><a style="color: black;" href="${pageContext.request.contextPath }/user/digitalresource.jsp">数字资源</a></b></div>
    		<div class="div11"><b style="color: black;"><a style="color: black;" href="${pageContext.request.contextPath }/user/reading.jsp">移动阅读</a></b></div>	
    	</div>
    	
    	<div style="background-color: ;float: left; width: 85%;height: 100%;text-align: center;" >
    		<br>
    		<b style="font-family: '楷体';font-size: 40px;color: black">移动阅读</b>
    		<hr>
			<p style="text-align: left;font-size: 18px;line-height: 22px;"><b>1.超星移动图书馆：</b>移动终端请在Android应用市场或苹果App Store下载“超星移动图书馆“<img src="${pageContext.request.contextPath }/img/superstar.png"/>或扫描二维码下载。App内有海量电子书在线阅读、下载、公开课、书目检索等，仅面向成都图书馆的注册读者（身份证、旧证）。</p>
			<img src="${pageContext.request.contextPath }/img/superstar-mark.jpg"/>
			<p style="text-align: left;font-size: 18px;line-height: 22px;">备注：由于读者注册方式不同，App开启后登录账号和密码有差异，分别是：</p>
			<p style="text-indent: 3em;text-align: left;font-size: 18px;line-height: 22px;">身份证注册读者的账号：身份证号 密码：注册时设置的密码</p>
			<p style="text-indent: 3em;text-align: left;font-size: 18px;line-height: 22px;">旧证读者的账号：读者证号 密码：本人身份证号后8位</p>
			<p style="text-align: left;font-size: 18px;line-height: 22px;"><b>2.电子书借阅机：</b>成都图书馆在成都市公共场所设置有60多台电子书借阅机，利用超星移动图书馆app <img src="${pageContext.request.contextPath }/img/superstar.png"/>，直接扫描屏幕中的图书封面二位码进行该书下载。</p>
    	</div>
    </div>
